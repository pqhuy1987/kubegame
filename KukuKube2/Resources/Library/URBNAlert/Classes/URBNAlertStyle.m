...
#pragma mark - Title
- (UIColor *)titleColor {
    return _titleColor ?: [UIColor colorWithRed:0.286 green:0.342 blue:0.467 alpha:1];
}

- (UIFont *)titleFont {
    return _titleFont ?: [UIFont boldSystemFontOfSize:25];
}
...
- (UIColor *)messageColor {
    return _messageColor ?: [UIColor colorWithRed:0.286 green:0.342 blue:0.467 alpha:1];
}

- (UIFont *)messageFont {
    return _messageFont ?: [UIFont boldSystemFontOfSize:16];
}
...
- (UIFont *)errorTextFont {
    return _errorTextFont ?: [UIFont fontWithName:@"DIN Alternate Bold"  size:25];
}
...
- (UIFont *)buttonFont {
    return _buttonFont ?: [UIFont boldSystemFontOfSize:16];
}

- (UIColor *)buttonBackgroundColor {
    return _buttonBackgroundColor ?: [UIColor colorWithRed:0.855 green:0.343 blue:0.418 alpha:1];
}

- (UIColor *)destructionButtonBackgroundColor {
    return _destructionButtonBackgroundColor ?: [UIColor colorWithRed:0.286 green:0.342 blue:0.467 alpha:1];
}
